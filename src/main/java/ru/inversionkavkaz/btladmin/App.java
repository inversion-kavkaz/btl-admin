package ru.inversionkavkaz.btladmin;
...
import ru.inversionkavkaz.btladmin.controller.ViewIkBtlFogController;
...
public class App extends BaseApp
{
    ...
    {
        new FXFormLauncher<> (tc, vc, ViewIkBtlFogController.class)
            .initProperties (p)
            .show ();
    }
